...
@section('container')
    <div class="container-fluid rounded-3 mt-2 pt-2 shadow-sm header" style="height: 50px">
        <h4><a href="/pemilik/karyawan" class="text-decoration-none">Data Admin Karyawan</a> / Ubah</h4>
    </div>
    ...
    <div class="container-fluid border container-content shadow-sm" >
        ...
        @endif
        <form method="post" action="/pemilik/karyawan/{{ $user->id }}" class="m-3 mx-4">
            @method('put')
            @csrf
            <!--Nama-->
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-5">
                    <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" value="{{ $user->username, old('username') }}">
