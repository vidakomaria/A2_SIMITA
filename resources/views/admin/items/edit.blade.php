...
@section('container')
    <div class="container m-4 table-responsive col-lg-auto items">
        ...
        <div class="col-lg-8">
            <form method="post" action="/admin/items/{{ $item->id_barang }}" class="mb-5">
                @method('put')
                @csrf
                <div class="mb-3">
...
{{--                        @endforeach--}}
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('harga_jual') is-invalid @enderror" id="harga_jual" name="harga_jual" disabled value="{{ $item->harga_jual }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('stok') is-invalid @enderror" id="stok" name="stok" placeholder="{{ $item->stok }}" required value="{{ old('stok') }}">
