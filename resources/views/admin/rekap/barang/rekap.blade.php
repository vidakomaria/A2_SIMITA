...
{{--                    <button type="" class="btn btn-orange me-md-2 text-white"><i class="bi bi-printer"></i> Cetak</button>--}}
                </div>
            </div>
        </form>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="/admin/rekap/barang/print/{{ $tglAwal }}/{{ $tglAkhir }}" target="_blank"><button class="btn btn-orange">IYA</button></a>
